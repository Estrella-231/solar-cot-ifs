...
receipt=ROOT/'audits/weather_head_submission_20260912_v1.json'
intent=ROOT/'audits/weather_head_submission_20260912_v1.intent'
if receipt.exists():
...
assert not (ROOT/'runs/weather_coverage_head_seed42_20260912_v1').exists()
assert not (ROOT/'weather_head_20260912_v1_pbs.log').exists()
manifest=json.loads((ROOT/'audits/weather_head_launch_sha256_20260912.json').read_text())
...
result=subprocess.run([PBS+'qsub','scripts/run_weather_head_20260912.pbs'],cwd=ROOT,capture_output=True,text=True)
