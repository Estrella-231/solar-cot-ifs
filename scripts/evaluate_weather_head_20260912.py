...
import numpy as np
from train_weather_head_20260912 import sha,write,classification
...
def main():
    run=ROOT/'runs/weather_coverage_head_seed42_20260912_v1';pack=ROOT/'data/head_pack_trainval_20260908_v1'
