...
- B1 完成结果：A0/AH/AI/O_diag两站等权RMSE分别147.639/148.852/148.773/130.109 W/m²；完整同键验证99,849行、test=false。O_diag−AI为−18.664 W/m²；72个起报日期配对bootstrap 95%区间[−23.062,−14.327]，AI−AH的区间[−2.301,+2.048]跨零。AI相对O_diag的逐时效RMSE差从+15分钟5.32增至+240分钟31.13 W/m²。O_diag只表明本链路可利用更好的未来COT，不能部署，亦非物理COT真实性证明。逐样本预测与审核JSON在 `results/cot_dynamics_20260924/ghi_b1/`，bootstrap在 `audits/cot_dynamics_20260924/ghi_b1_day_bootstrap_v1.json`。
